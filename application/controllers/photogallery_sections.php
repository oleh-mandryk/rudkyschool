...
class Photogallery_sections extends CI_Controller
{
    ...
    //start_from - з якої фотографії починати вивід для кожної сторінки
    ...
    public function show($photogallery_section_id,$start_from = 0)
    {
        ...
        {
            //Задаємо обмеження кількості фотографій на сторінку на сторінку
            $limit = $this->config->item('user_per_photo');
            
            //Зчитуємо загальну кількість фото в конкретній категорії
