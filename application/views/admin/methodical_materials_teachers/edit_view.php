<div id="content">
<div id="left">
<h2>Редагування методичного матеріалу для вчителя</h2>
<form action = "<?=base_url()."methodical_materials/update_teachers/$methodical_materials_teachers_id";?>" method="post">
